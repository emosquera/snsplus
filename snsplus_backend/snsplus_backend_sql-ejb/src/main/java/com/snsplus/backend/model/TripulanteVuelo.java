 ...
 */
@Entity
@Table(name = "tripulante_vuelo")
public class TripulanteVuelo extends TripulanteVueloDTO {
    private Vuelo vuelo;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TripulanteVuelo)) {
            return false;
        }
        TripulanteVuelo other = (TripulanteVuelo) object;
        return !((this.id == null && other.id != null) || (this.id != null && !this.id.equals(other.id)));
    }

    @Override
    public String toString() {
        return "com.snsplus.backend.model.TripulanteVuelo[ id=" + id + " ]";
    }
