 ...
 * @author conamerica15
 */
@XmlRootElement(name = "fase_operacion")
public class FaseOperacionDTO extends GeneralDTO{
    private FaseDTO faseDTO;
    private TipoOperacion tipoPadre;
    private EstatusFaseEvento estatus;
    private List<ValorIndicadorFaseDTO> valorIndicadorDTOs;

    public FaseDTO getFaseDTO() {
        if (faseDTO == null){
            faseDTO = new FaseDTO();
        }
        return faseDTO;
    ...
    public void setFaseDTO(FaseDTO faseDTO) {
        this.faseDTO = faseDTO;
    }
    ...
    public List<ValorIndicadorFaseDTO> getValorIndicadorDTOs() {
    ...
    public void setValorIndicadorDTOs(List<ValorIndicadorFaseDTO> valorIndicadorDTOs) {
