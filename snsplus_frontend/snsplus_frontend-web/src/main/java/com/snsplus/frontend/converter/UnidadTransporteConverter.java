 ...
 * @author conamerica15
 */
@FacesConverter(value = "unidadTransporteConverter", forClass = UnidadTransporteDTO.class)
public class UnidadTransporteConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if (value == null || value.equals("")) {
            ...
            return String.valueOf(((UnidadTransporteDTO) value).getId());
        }
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        if (value.trim().equals("")) {
            ...
            try {
                ...
                for (Map.Entry<String, UnidadTransporteDTO> u : datosPrueba.getAviones().entrySet()) {
